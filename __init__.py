...
download = on_regex("^(下载)$", block=True,  priority=5)
...
cdlinux = on_regex("^(cdlinux)$", block=True, priority=5)
...
kali = on_regex("^(kali)$", block=True,  priority=5)
...
pojie = on_regex("^(破解)$", block=True,  priority=5)
